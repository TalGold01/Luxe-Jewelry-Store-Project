...
### Auth Service
1. Navigate to src/auth-service:
   cd src/auth-service
...
### Frontend
1. Navigate to src/jewelry-store:
   cd ../jewelry-store
2. Install dependencies:
   npm install
3. Create .env file with:
   REACT_APP_API_BASE_URL=http://localhost:8000
   REACT_APP_AUTH_BASE_URL=http://localhost:8001
4. Run:
   npm start

### Testing
- Open browser at http://localhost:3000
- Register, login, browse products, add items to cart
